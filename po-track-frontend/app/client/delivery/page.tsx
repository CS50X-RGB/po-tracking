    ...
    return (
      <div className="flex flex-col items-center gap-4 p-5 w-full">
        <div className="flex flex-row justify-between items-center gap-4 w-full">
          <h1 className="font-bold text-xl">Delivery Management</h1>
          <div className="flex flex-row items-center gap-4 w-full">
            <Chip color="success">Clear for Shipping</Chip>
            <Chip color="warning">Delivery On Hold</Chip>
            <Chip color="danger">Deffred Delivery</Chip>
          </div>
        </div>
        {deliveries.map((d: any, index: number) => {
          ...
          return (
            ...
            >
              ...
              {/* Tentative Plan Modal */}
              <CustomModal
                heading="Add Tentative Plan Date"
                bottomContent={
                  <div className="flex flex-end w-full">
